"""MatMul (Cube core) code generator."""
from __future__ import annotations

import jinja2

from ascend_transpiler.ir.operator_ir import OperatorIR
from ascend_transpiler.ops.mappings import DTYPE_TO_CPP
...
class MatMulCodegen:
    ...
    def render(self, ir: OperatorIR) -> dict[str, str]:
        if len(ir.inputs) < 2:
            raise ValueError("MatMul operator requires exactly 2 inputs")
        ...
        kernel_tmpl = self._env.get_template("kernel_matmul.cpp.j2")
